...
def wrap_code(code: str, args: str = "", auto_return: bool = True) -> ast.Module:
    ...
    for node in ast.walk(mod):
        node.lineno = -100_000  # type: ignore[reportAttributeAccessIssue]
        node.end_lineno = -100_000  # type: ignore[reportAttributeAccessIssue]
    ...
    async def traverse(
        ...
        try:
            if inspect.isasyncgenfunction(func):
                ...
                func_a: typing.Callable[..., typing.Awaitable[typing.Any]] = func  # type: ignore[reprotAssignmentType]
