...
class ShellFeature(Feature):
    ...
    class ShellStandardInputModal(ui.Modal, title="Type input"):
        ...
        stdin_content: ui.TextInput[ui.Modal] = ui.TextInput(
    ...
    if shutil.which("node") and shutil.which("npm"):
        ...
        async def jsk_node(
            ...
            *,
            argument: codeblock_converter,  # type:ignore[reportGeneralTypeIssue]
        ):
            """
    ...
    if shutil.which("pyright"):
        ...
        async def jsk_pyright(
            ...
            ctx: commands.Context,  # type:ignore[reportMissingTypeArgument]
            *,
            argument: codeblock_converter,  # type: ignore[reportCallIssue]
        ):
            """
