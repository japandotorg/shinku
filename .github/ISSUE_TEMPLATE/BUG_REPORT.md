...
- [ ] I have updated discord.py and shinku to the latest available versions and have confirmed that this issue is still present
...
<!-- Post information both about your shinku AND discord.py version here -->
<!-- You can get information about discord.py by running `python -m discord -v` -->
<!-- You can get your shinku version by running `pip show shinku` -->
