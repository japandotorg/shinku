...
shinku contains numerous internal classes and functions it uses to facilitate
...
of shinku, and how they work, are subject to change.
...
.. currentmodule:: shinku.functools
...
.. code:: python3
    ...
    from shinku.help_command import MinimalPaginatorHelp

    bot = commands.Bot('?', help_command=MinimalPaginatorHelp())

.. currentmodule:: shinku.help_command
